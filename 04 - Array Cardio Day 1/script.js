...
/* const filter1500 = inventors.filter(
  (item) => item.year >= 1500 && item.year < 1600
);
console.table(filter1500); */

// Array.prototype.map()
// 2. Give us an array of the inventors first and last names
/* const namesArr = [];
inventors.forEach((item) => {
  namesArr.push(item.first + " " + item.last);
});
...
/* console.log(
  inventors.reduce((num1, num2) => num1 + (num2.passed - num2.year), 0)
); */

// 5. Sort the inventors by years lived
/* const yearsSorted = inventors.sort(
